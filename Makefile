...
#   "make -C app/builder/Z3GatewayHost651c INCLUDE_MAKEFILE=my-custom.mak"
#   or 
#   "cd app/builder/Z3GatewayHost651c; make INCLUDE_MAKEFILE=my-custom.mak"
#
...
INCLUDES= \
  ...
  -I./../../../protocol/zigbee/app/framework/util \
  -I./../../../app/builder/Z3GatewayHost651c \
  -I./../../../platform/base/hal \
...
APP_BUILDER_CONFIG_HEADER=$(APP_BUILDER_OUTPUT_DIRECTORY)/Z3GatewayHost651c.h
APP_BUILDER_STORAGE_FILE=$(APP_BUILDER_OUTPUT_DIRECTORY)/Z3GatewayHost651c_endpoint_config.h
...
DEFINES = \
  ...
  -DPLATFORM_HEADER=$(PLATFORM_HEADER_FILE) \
    -DBOARD_HOST \
  -DBOARD_HEADER=\"app/builder/Z3GatewayHost651c/Z3GatewayHost651c_board.h\" \
...
APPLICATION_FILES= \
  ...
  ../../../app/builder/Z3GatewayHost651c/cli.c \
...
TARGET_FILE= $(EXE_DIR)/Z3GatewayHost651c$(ARCHIVE_EXTENSION)
else
TARGET_FILE= $(EXE_DIR)/Z3GatewayHost651c
endif
